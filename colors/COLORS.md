Color files for NoCarrierMail
=============================

The color file lets you specify the colors used by NoCarrierMail (on color
terminals). When you run NoCarrierMail for the first time, the file "colors"
will be automatically generated in the "ncmail" directory, listing the
default colors.
...
up the color file once, so you can use NoCarrierMail from both color and mono
...
in your .ncmailrc to point to a new file. The example color files included
here are:
